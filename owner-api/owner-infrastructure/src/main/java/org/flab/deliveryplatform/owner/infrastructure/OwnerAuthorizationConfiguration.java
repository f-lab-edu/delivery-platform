...
import org.flab.deliveryplatform.owner.infrastructure.persistance.OwnerMemoryAuthorizationRepository;
...
public class OwnerAuthorizationConfiguration {
    ...
    public AuthorizationRepository ownerAuthorizationRepositoryAdapter(
        OwnerMemoryAuthorizationRepository authorizationRepository) {
